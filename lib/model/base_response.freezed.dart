...
abstract class _Meta implements Meta {
  const factory _Meta({final String? version}) = _$_Meta;
...
abstract class $ErrorModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({int code, String title, String message});
}
...
class _$_ErrorModel implements _ErrorModel {
  ...
  @override
  String toString() {
    return 'ErrorModel(code: $code, title: $title, message: $message)';
  }
